...
export const ui = {
  es: {
    ...
    'contact.subtitle':
      'Cuéntame qué necesitas y te respondo en 24h con una propuesta a medida. Sin compromiso.',
    ...
    'contact.form.consent.pre': 'He leído y acepto la',
    ...
    'contact.direct': 'También puedes escribirme',
    ...
    'cta.final.subtitle':
      'Cuéntame tu proyecto hoy y en 24h tienes una propuesta clara sobre la mesa.',
  ...
  va: {
    ...
    'contact.subtitle':
      'Conta’m què necessites i et responc en 24h amb una proposta a mida. Sense compromís.',
    ...
    'contact.form.consent.pre': 'He llegit i accepte la',
    'contact.form.consent.link': 'política de privacitat',
    'contact.book': 'Reserva una trucada gratis',
    'contact.book.sub': '15 minuts per videotrucada, sense compromís',
    'contact.direct': 'També pots escriure’m',
    'contact.email.label': 'Email',
  ...
  en: {
    ...
    'contact.subtitle':
      'Tell me what you need and I’ll reply within 24h with a tailored proposal. No commitment.',
    ...
    'contact.form.consent.pre': 'I have read and accept the',
    ...
    'contact.direct': 'Or write to me directly',
    'contact.email.label': 'Email',
